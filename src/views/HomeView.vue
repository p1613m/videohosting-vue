  ...
  <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
    <div class="col">
      <div class="card shadow-sm">
        ...
        <div class="card-body">
          <p class="card-text fw-bold">Video name</p>
          <div class="d-flex justify-content-between align-items-center">
            <div class="btn-group">
              <a href="video.html" class="btn btn-sm btn-outline-secondary">View</a>
            </div>
            <small class="text-muted">Duration: 9 mins, Likes: 2</small>
          </div>
        </div>
      </div>
    </div>
